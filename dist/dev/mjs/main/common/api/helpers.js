import { HttpDataType } from './contracts/http'; // from: https://stackoverflow.com/a/37562814/5221762

export function toFormUrlEncoded(args) {
  const formBody = [];
...
export function prepareHttpRequest(request) {
