...
export function getDisplayName(value) {
  ...
  if (typeof value === 'object') {
    const name = value instanceof CalcProperty && value.state.name || value instanceof Connector && value.connectorState.name;
...
const emptyObject = {};
export function deepMerge(options, base, ...others) {
...
function _deepMerge(options, base, other) {
  ...
  for (const key in base) {
    if (Object.prototype.hasOwnProperty.call(base, key)) {
      const v1 = base[key];
      const v2 = Object.prototype.hasOwnProperty.call(other, key) ? other[key] : void 0;
  ...
  for (const key in other) {
    if (Object.prototype.hasOwnProperty.call(other, key)) {
      const v1 = Object.prototype.hasOwnProperty.call(base, key) ? base[key] : void 0;
      const v2 = other[key];
      base[key] = _deepMerge(options, v1, v2);
    }
  }
...
export class WebrainObservableMap extends ObservableMap {}
export class WebrainMap extends Map {}
