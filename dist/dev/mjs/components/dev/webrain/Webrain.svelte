<script context="module">
	...
	const createConnector = connectorFactory({
		...
		buildRule: c => c
			.connect('visData', b => b.p('visData'))
			.connectWritable('isEnabled', b => b.p('isEnabled'))
			.connectWritable('highlightMode', b => b.p('highlightMode'))
			.connectWritable('searchPattern', b => b.p('searchPattern'))
	})
...
<!--		<pre class="graph__controls__info flex__item&#45;&#45;fill">subscribers: {subscribersCount}-->
	</div>
</div>
