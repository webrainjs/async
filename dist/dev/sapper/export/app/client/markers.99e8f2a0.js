...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      attr_dev(div, "class", "container svelte-2i2hn0");
...
function (_SvelteComponentDev) {
  _inherits(Markers, _SvelteComponentDev);
  ...
  function Markers(options) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Markers).call(this, options));
