import { _ as _inherits, a as _classCallCheck, b as _possibleConstructorReturn, c as _getPrototypeOf, i as init, s as safe_not_equal, d as _assertThisInitialized, e as dispatch_dev, S as SvelteComponentDev, a6 as _sortInstanceProperty, Q as onMount, q as _sliceInstanceProperty, t as element, G as text, H as space, v as claim_element, w as children, I as claim_text, k as _forEachInstanceProperty, y as detach_dev, J as claim_space, z as attr_dev, A as add_location, B as insert_dev, K as append_dev, n as noop, a7 as listen_dev, a3 as destroy_each, a8 as _JSON$stringify, a9 as _filterInstanceProperty, aa as _mapInstanceProperty, ab as _Array$from, ac as _trimInstanceProperty, U as binding_callbacks } from './client.f26f53d6.js';
...
function create_each_block(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      attr_dev(span0, "class", "fonts__prefix svelte-1i1yvdx");
      add_location(span0, file, 43, 5, 1143);
      attr_dev(td0, "class", "fonts__cell fonts__name table-layout__cell svelte-1i1yvdx");
      add_location(td0, file, 42, 4, 1082);
      attr_dev(span1, "class", span1_class_value = "font-" +
      /*font*/
      ctx[5] + " svelte-1i1yvdx");
      add_location(span1, file, 46, 5, 1253);
      attr_dev(td1, "class", "fonts__cell table-layout__cell svelte-1i1yvdx");
      add_location(td1, file, 45, 4, 1204);
      attr_dev(tr, "class", "table-layout__row svelte-1i1yvdx");
...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      attr_dev(table, "class", "fonts table-layout svelte-1i1yvdx");
      add_location(table, file, 39, 1, 985);
      attr_dev(div, "class", "container flex flex--vertical svelte-1i1yvdx");
