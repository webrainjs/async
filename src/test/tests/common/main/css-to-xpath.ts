...
describe('common > main > css-to-xpath', function () {
    ...
    function test(css: string, checkXPath: string) {
        let xPath: string;
        try {
    ...
    function testSeparator(css1: string, css2: string, xPath1: string, xPath2: string, cssSeparator: string, xPathSeparator: string, test: (css: string, xpath: string) => void) {
    ...
    function testSeparators(css1: string, css2: string, xPath1: string, xPath2: string, convertSeparatorsDict: Map<string, [string, string]>, test: (css: string, xpath: string) => void) {
    ...
    function testSeparatorsMap(convertSelectorsDict: Map<string, string>, convertSeparatorsDict: Map<string, [string, string]>) {
