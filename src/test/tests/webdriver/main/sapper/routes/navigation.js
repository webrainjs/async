...
function errorPredicate(log) {
	...
	if (message.endsWith('0:0 Uncaught (in promise) AbortError: Failed to register a ServiceWorker: ServiceWorker script evaluation failed')
