...
// 			// console.debug('calculatedObservable', e)
// 			setTimeout(() => {
// 				this.setNode({
// 					object: e.target,
...
// 		// 			},
// 		// 		})
// 		// 		// console.debug('connectorObservable', e)
// 		// 	})
...
// 		// 			}
// 		// 		}
// 		// 		// console.debug('dependencyObservable', e)
// 		// 	})
...
// 					})
// 				}
// 				// console.debug('deepSubscribeObservable', e)
// 			})
...
// 				}
//
// 				// let minUpdateId = state.data.minUpdateId || 0
// 				// let maxUpdateId = minUpdateId
// 				const currentUpdateId = updateId[0]
//
// 				const searchPattern = yield input.searchPattern
//
// 				let searchRegexp
// 				try {
// 					searchRegexp = searchPattern && new RegExp(searchPattern, 'ig')
// 				} catch (ex) {
// 					console.error(ex)
// 				}
//
// 				const highlightMode = yield input.highlightMode
//
...
// 				}
//
// 				const nodes = yield input.nodes
//
// 				for (const item of Array.from(nodes.values()).sort((o1, o2) => o1.updateId - o2.updateId)) {
...
// 				}
//
// 				const edges = yield input.edges
//
// 				for (const item of Array.from(edges.values()).sort((o1, o2) => o1.updateId - o2.updateId)) {
...
// 				// endregion
//
// 				// state.data.minUpdateId = maxUpdateId + 1
//
// 				// console.debug('webrain update count = ' + (value.nodes.length + value.edges.length))
// 				// console.debug('webrain update: ', value)
//
// 				return value
// 			},
// 			deferredOptions: {
